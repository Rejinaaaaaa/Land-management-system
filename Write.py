...
def print_rent_invoice(customer_name, phone_number, land, price, selected_anna, total_price, duration, current_datetime):
    invoice_content =(
        "\nInvoice:\n" +
        "-----------------------------------------------------------------------------------------------------------------\n"
...
def print_return_invoice(customer_name, phone_number, land, selected_land, total_price, rental_months, returned_months, fine, current_datetime):
    invoice_content =(
        "\nInvoice:\n"
        "-----------------------------------------------------------------------------------------------------------------\n"
        "-------------------------------------Welcome to Techno Property Nepal Portal-------------------------------------\n"
