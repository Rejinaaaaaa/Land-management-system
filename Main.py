...
# Function to validate a phone number (10 digits only)
    ...
    while True:
        try:
            ...
            while not is_valid_phone_number(phone_number):
                print("Please enter a valid phone number (10 digits only).")
                phone_number = input("Enter your phone number: ")
            ...
            if land:
                ...
                invoice_content = Write.print_rent_invoice(customer_name, phone_number, land, land["price"], selected_anna, total_price, duration, current_datetime)
...
def return_land():
  ...
  while True:
    try:
      ...
      current_datetime = datetime.datetime.now()
      invoice_content = Write.print_return_invoice(customer_name, phone_number, land, selected_land, total_price, rental_months, returned_months, fine, current_datetime)
      invoices_content.append(invoice_content)
      print(invoice_content)
...
def display_welcome():
    ...
    print("-----------------------------------------------------------------------------------------------------------------")
    print("About Us: Techno Property Nepal is a leading land rent and return company in Nepal.")
    print("We specialize in providing prime lands for rent and ensure hassle-free land return procedures.")
    print("-----------------------------------------------------------------------------------------------------------------")
    print("Contact Us:")
    print("Address: Kamalpokhari, Kathmandu, Nepal")
    print("Email: contact@technopropertynepal.com")
    print("Phone: +977-4360949")
